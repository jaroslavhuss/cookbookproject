...
const updateMaterial = require("./routes/POST/updateMaterial");
const deleteMaterial = require("./routes/POST/deleteMaterial");
const app = express();
...
app.use(cors(), updateMaterial);
app.use(cors(), deleteMaterial);
